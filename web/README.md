...
- [ ] src/views/Agent/List.vue - Agent 列表
- [ ] src/views/Agent/components/CreateDialog.vue - 创建 Agent 弹窗
- [ ] src/views/Agent/components/TokenDialog.vue - Token 弹窗
- [ ] src/views/STCP/List.vue - STCP 实例列表
