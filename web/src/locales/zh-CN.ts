export default {
  ...
  tailscale: {
    ...
    derpUrl: 'DERP 服务器地址',
    derpUrlPlaceholder: '留空则使用公网地址 + /derp',
    derpUrlTip: 'P2P 连接失败时使用的中继服务器，留空则使用公网地址 + /derp',
    stunPort: 'STUN 端口',
  ...
  agentAuth: {
    ...
    addAuth: '添加授权',
    authList: '授权列表',
    visitorAgent: '访问方Agent',
    visitorAgentIp: '访问方IP',
    targetService: '目标服务',
    targetAddress: '目标地址',
    grantedAt: '授权时间',
    grantedBy: '授权人',
    selectVisitorAgent: '选择访问方Agent',
    selectVisitorAgentPlaceholder: '请选择访问方Agent',
    selectTargetService: '选择要访问的服务',
    selectTargetServicePlaceholder: '请选择要访问的服务',
    noGroupAgent: '无分组Agent',
    crossGroupAgent: '跨组Agent',
    sameGroupTip: '同组 Agent 默认可互访，不在此列表显示',
    aclSyncWarning: '⚠️ 授权后，该 Agent 可以通过 Tailscale 网络访问选中的服务',
    ...
    authSuccess: '授权成功',
    authFailed: '授权失败',
    selectAgentAndService: '请选择访问方Agent和目标服务',
    loadAgentsFailed: '加载Agent列表失败',
    loadServicesFailed: '加载服务列表失败',
