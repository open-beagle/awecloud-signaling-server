export default {
  ...
  tailscale: {
    ...
    derpUrl: 'DERP Server URL',
    derpUrlPlaceholder: 'Leave empty to use public URL + /derp',
    derpUrlTip: 'Relay server used when P2P connection fails, leave empty to use public URL + /derp',
    stunPort: 'STUN Port',
