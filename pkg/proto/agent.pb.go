...
const file_pkg_proto_agent_proto_rawDesc = "" +
	...
	"\arunning\x18\x02 \x01(\bR\arunning\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\"\xde\t\n" +
	...
	"\x1ccontainer_ssh_session_events\x18\x14 \x03(\v2,.awecloud.signaling.ContainerSSHSessionEventR\x19containerSshSessionEvents\"\x94\x05\n" +
	...
	"targetAddr\x12\x18\n" +
	"\aenabled\x18\x06 \x01(\bR\aenabled\"\x99\r\n" +
	...
	"\x19workload_inventory_config\x18\x14 \x01(\v2+.awecloud.signaling.WorkloadInventoryConfigR\x17workloadInventoryConfig\"\xea\x03\n" +
...
var file_pkg_proto_agent_proto_goTypes = []any{
	...
	(*SupplyInventoryEnvelope)(nil),      // 45: awecloud.signaling.SupplyInventoryEnvelope
	(*WorkloadInventoryEnvelope)(nil),    // 46: awecloud.signaling.WorkloadInventoryEnvelope
	(*SupplyInventoryAck)(nil),           // 47: awecloud.signaling.SupplyInventoryAck
	(*WorkloadInventoryAck)(nil),         // 48: awecloud.signaling.WorkloadInventoryAck
}
var file_pkg_proto_agent_proto_depIdxs = []int32{
	...
	41, // 13: awecloud.signaling.ConnectedEndpoint.capabilities:type_name -> awecloud.signaling.EndpointCapabilityInfo
	39, // 14: awecloud.signaling.ConnectedEndpoint.discovered_services:type_name -> awecloud.signaling.DiscoveredK8SService
	40, // 15: awecloud.signaling.ConnectedEndpoint.update_statuses:type_name -> awecloud.signaling.UpdateStatus
	11, // 16: awecloud.signaling.AgentHeartbeatResponse.services:type_name -> awecloud.signaling.ServiceConfig
	12, // 17: awecloud.signaling.AgentHeartbeatResponse.forwards:type_name -> awecloud.signaling.ForwardConfig
	16, // 18: awecloud.signaling.AgentHeartbeatResponse.k8s_permissions:type_name -> awecloud.signaling.K8SPermission
	17, // 19: awecloud.signaling.AgentHeartbeatResponse.k8s_service_permissions:type_name -> awecloud.signaling.K8SServicePermission
	15, // 20: awecloud.signaling.AgentHeartbeatResponse.capability_config:type_name -> awecloud.signaling.AgentCapabilityConfig
	20, // 21: awecloud.signaling.AgentHeartbeatResponse.endpoint_ssh_permissions:type_name -> awecloud.signaling.EndpointSSHPermission
	18, // 22: awecloud.signaling.AgentHeartbeatResponse.endpoint_k8sapi_permissions:type_name -> awecloud.signaling.EndpointK8SAPIPermission
	19, // 23: awecloud.signaling.AgentHeartbeatResponse.endpoint_k8sservice_permissions:type_name -> awecloud.signaling.EndpointK8SServicePermission
	14, // 24: awecloud.signaling.AgentHeartbeatResponse.endpoint_capability_configs:type_name -> awecloud.signaling.EndpointCapabilityConfig
	...
	44, // 29: awecloud.signaling.AgentHeartbeatResponse.workload_inventory_config:type_name -> awecloud.signaling.WorkloadInventoryConfig
	43, // 30: awecloud.signaling.EndpointCapabilityConfig.supply_inventory_config:type_name -> awecloud.signaling.SupplyInventoryConfig
	44, // 31: awecloud.signaling.EndpointCapabilityConfig.workload_inventory_config:type_name -> awecloud.signaling.WorkloadInventoryConfig
	1,  // 32: awecloud.signaling.GetRealtimeStatusResponse.networks:type_name -> awecloud.signaling.NetworkInterface
	26, // 33: awecloud.signaling.ReportProxyStatusRequest.statuses:type_name -> awecloud.signaling.ProxyStatus
	29, // 34: awecloud.signaling.ReportVisitorStatusRequest.statuses:type_name -> awecloud.signaling.VisitorStatus
	1,  // 35: awecloud.signaling.ReportNetworkChangeRequest.networks:type_name -> awecloud.signaling.NetworkInterface
	38, // 36: awecloud.signaling.ContainerDiscoveryCandidate.labels:type_name -> awecloud.signaling.ContainerDiscoveryCandidate.LabelsEntry
	2,  // 37: awecloud.signaling.AgentService.Register:input_type -> awecloud.signaling.AgentRegisterRequest
	4,  // 38: awecloud.signaling.AgentService.Authenticate:input_type -> awecloud.signaling.AgentAuthenticateRequest
	8,  // 39: awecloud.signaling.AgentService.Heartbeat:input_type -> awecloud.signaling.AgentHeartbeatRequest
	45, // 40: awecloud.signaling.AgentService.ReportSupplyInventory:input_type -> awecloud.signaling.SupplyInventoryEnvelope
	46, // 41: awecloud.signaling.AgentService.ReportWorkloadInventory:input_type -> awecloud.signaling.WorkloadInventoryEnvelope
	24, // 42: awecloud.signaling.AgentService.GetRealtimeStatus:input_type -> awecloud.signaling.GetRealtimeStatusRequest
	27, // 43: awecloud.signaling.AgentService.ReportProxyStatus:input_type -> awecloud.signaling.ReportProxyStatusRequest
	30, // 44: awecloud.signaling.AgentService.ReportVisitorStatus:input_type -> awecloud.signaling.ReportVisitorStatusRequest
	32, // 45: awecloud.signaling.AgentService.ReportNetworkChange:input_type -> awecloud.signaling.ReportNetworkChangeRequest
	34, // 46: awecloud.signaling.AgentService.SVCProxy:input_type -> awecloud.signaling.SVCProxyData
	35, // 47: awecloud.signaling.AgentService.GetUserDeviceInfo:input_type -> awecloud.signaling.GetUserDeviceInfoRequest
	3,  // 48: awecloud.signaling.AgentService.Register:output_type -> awecloud.signaling.AgentRegisterResponse
	5,  // 49: awecloud.signaling.AgentService.Authenticate:output_type -> awecloud.signaling.AgentAuthenticateResponse
	13, // 50: awecloud.signaling.AgentService.Heartbeat:output_type -> awecloud.signaling.AgentHeartbeatResponse
	47, // 51: awecloud.signaling.AgentService.ReportSupplyInventory:output_type -> awecloud.signaling.SupplyInventoryAck
	48, // 52: awecloud.signaling.AgentService.ReportWorkloadInventory:output_type -> awecloud.signaling.WorkloadInventoryAck
	25, // 53: awecloud.signaling.AgentService.GetRealtimeStatus:output_type -> awecloud.signaling.GetRealtimeStatusResponse
	28, // 54: awecloud.signaling.AgentService.ReportProxyStatus:output_type -> awecloud.signaling.ReportProxyStatusResponse
	31, // 55: awecloud.signaling.AgentService.ReportVisitorStatus:output_type -> awecloud.signaling.ReportVisitorStatusResponse
	33, // 56: awecloud.signaling.AgentService.ReportNetworkChange:output_type -> awecloud.signaling.ReportNetworkChangeResponse
	34, // 57: awecloud.signaling.AgentService.SVCProxy:output_type -> awecloud.signaling.SVCProxyData
	36, // 58: awecloud.signaling.AgentService.GetUserDeviceInfo:output_type -> awecloud.signaling.GetUserDeviceInfoResponse
