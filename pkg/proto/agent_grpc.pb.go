...
func (UnimplementedAgentServiceServer) GetRealtimeStatus(context.Context, *GetRealtimeStatusRequest) (*GetRealtimeStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRealtimeStatus not implemented")
}
...
func (UnimplementedAgentServiceServer) ReportVisitorStatus(context.Context, *ReportVisitorStatusRequest) (*ReportVisitorStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportVisitorStatus not implemented")
}
func (UnimplementedAgentServiceServer) ReportNetworkChange(context.Context, *ReportNetworkChangeRequest) (*ReportNetworkChangeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportNetworkChange not implemented")
}
func (UnimplementedAgentServiceServer) SVCProxy(grpc.BidiStreamingServer[SVCProxyData, SVCProxyData]) error {
	return status.Errorf(codes.Unimplemented, "method SVCProxy not implemented")
}
