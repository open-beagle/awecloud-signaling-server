...
const (
	...
	DesktopService_ListDomains_FullMethodName           = "/awecloud.signaling.DesktopService/ListDomains"
)
...
func (c *desktopServiceClient) ListDomains(ctx context.Context, in *ListDomainsRequest, opts ...grpc.CallOption) (*ListDomainsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListDomainsResponse)
	err := c.cc.Invoke(ctx, DesktopService_ListDomains_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDesktopServiceServer) GetAuthorizedHosts(context.Context, *GetAuthorizedHostsRequest) (*GetAuthorizedHostsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAuthorizedHosts not implemented")
}
func (UnimplementedDesktopServiceServer) GetHostServices(context.Context, *GetHostServicesRequest) (*GetHostServicesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHostServices not implemented")
}
...
func (UnimplementedDesktopServiceServer) OfflineDevice(context.Context, *OfflineDeviceRequest) (*OfflineDeviceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OfflineDevice not implemented")
}
...
func (UnimplementedDesktopServiceServer) GetFavoriteServices(context.Context, *GetFavoriteServicesRequest) (*GetFavoriteServicesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFavoriteServices not implemented")
}
func (UnimplementedDesktopServiceServer) CheckSavedCredentials(context.Context, *CheckSavedCredentialsRequest) (*CheckSavedCredentialsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckSavedCredentials not implemented")
}
...
func (UnimplementedDesktopServiceServer) WaitForLoginResult(grpc.BidiStreamingServer[WaitForLoginResultRequest, WaitForLoginResultResponse]) error {
	return status.Errorf(codes.Unimplemented, "method WaitForLoginResult not implemented")
}
...
func (UnimplementedDesktopServiceServer) GetDomainList(context.Context, *GetDomainListRequest) (*GetDomainListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDomainList not implemented")
}
func (UnimplementedDesktopServiceServer) ListDomains(context.Context, *ListDomainsRequest) (*ListDomainsResponse, error) {
...
func _DesktopService_ListDomains_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDomainsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DesktopServiceServer).ListDomains(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DesktopService_ListDomains_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DesktopServiceServer).ListDomains(ctx, req.(*ListDomainsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DesktopService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DesktopService_ListDomains_Handler,
		},
	},
