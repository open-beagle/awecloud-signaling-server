...
type DomainRegistry struct {
	...
	ServicePorts    string             `gorm:"type:text" json:"service_ports,omitempty"`        // K8S Service 端口列表（k8ssvc 类型时，JSON 数组，如 "[5432,9187]"）
...
const (
	...
	DomainResourceService    DomainResourceKind = "service"
)
