...
type ConnectionAuditLog struct {
	...
	ClientID          int64     `gorm:"not null;index:idx_audit_logs_client_id" json:"client_id"`
	STCPInstanceID    int64     `gorm:"not null;index:idx_audit_logs_instance_id" json:"stcp_instance_id"`
