...
## 2025-12-29: Wails v3 升级计划（系统托盘）

### 背景

为实现系统托盘功能，需要升级 Wails v2 → v3。

- Wails v2 不支持系统托盘，第三方库在 macOS 上有符号冲突
- Wails v3 原生支持系统托盘，跨平台兼容

### 状态

- 设计文档：`docs/design_desktop_system_tray.md`
- 升级指南：`docs/changes_wails_v3.md`
- 实施状态：⏳ 待开始
